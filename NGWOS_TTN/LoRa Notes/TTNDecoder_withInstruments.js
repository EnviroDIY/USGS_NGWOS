 ...
 *   8       Vega Puls 21     Error Code                     dimensionless
...
function lppDecode(bytes) {
    ...
    while (i < bytes.length) {
        ...
        switch (s_no) {
            case 1:
                s_inst = "EnviroDIY Stonefly";
                s_param = "Timestamp (UNIX)";
                s_unit = "dimensionless";
                break;
            case 2:
                s_inst = "MultiTech mDot";
                s_param = "RSSI";
                s_unit = "dB";
                break;
            case 3:
                s_inst = "Sensirion SHT40";
                s_param = "Equipment Temperature";
                s_unit = "°C";
                break;
            case 4:
                s_inst = "Sensirion SHT40";
                s_param = "Relative Humidity";
                s_unit = "%RH";
                break;
            case 5:
                s_inst = "Vega Puls 21";
                s_param = "Gauge Height";
                s_unit = "m";
                break;
            case 6:
                s_inst = "Vega Puls 21";
            ...
            case 9:
                ...
                break;
            case 10:
                s_inst = "EVERBRIGHT ALS";
                s_param = "Luminosity";
                s_unit = "lux";
                break;
            case 11:
                s_inst = "MAX17048";
                s_param = "Battery Voltage";
                s_unit = "V";
                break;
            case 12:
                s_inst = "MAX17048";
                s_param = "Battery Charge Percent";
                s_unit = "%";
                break;
            case 13:
                s_inst = "MAX17048";
                s_param = "Battery (Dis)Charge Rate";
                s_unit = "%/hr";
                break;
            case 14:
                s_inst = "Meter Hydros 21";
                s_param = "Specific Conductance";
                s_unit = "µS/cm";
                break;
            case 15:
                s_inst = "Meter Hydros 21";
