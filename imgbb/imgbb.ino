...
#define WIFI_ID "4DsAndCounting"  // WiFi access point name
#define WIFI_PASSWD "W4171n843"   // WiFi password (WPA2)
#elif defined(USE_WIFI_HOTSPOT)
#define WIFI_ID "StaryShark"    // WiFi access point
#define WIFI_PASSWD "sekone23"  // WiFi password
#else
